...
- `/map-systems` — [If the concept exists but systems are still implicit]
- `/design-system [system-name]` — [If a high-priority system still lacks a GDD]
- `/prototype [mechanic]` — [If a risky system needs validation]
- `/gate-check [phase]` — [If stage readiness needs a formal verdict]

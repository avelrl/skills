...
[What the player should feel or understand when interacting with this system.]
...
- **Inputs**: [Inputs]
- **Notes**: [Clamps, exceptions, special cases]
...
- **Depends on**: [Systems or data]
- **Used by**: [Systems or data]

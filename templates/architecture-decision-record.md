...
- **Source**: [existing code path, system, or migration]
- **Implementation Status**: [not started | partial | live]
- **Confidence Notes**: [what was inferred rather than explicitly decided]
...
- [Technical constraints -- platform limits, compatibility, operational realities]
...
| Latency / load time | [X] | [Y] | [Z] |
| Network (if applicable) | [X] | [Y] | [Z] |
...
- [Link to related design or technical documents]

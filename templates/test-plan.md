...
- **Feature**: [Name]
- **Spec / Design Doc**: [Link to source document]
...
- **Environment**: [Target platform, runtime, browser, device, etc.]
- **Preconditions**: [Required data, accounts, configuration, or prior state]

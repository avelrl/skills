...
- **Related Product/Design Doc**: [Link if applicable]
...
- **Performance**: [Budget — e.g., latency, throughput, batch time]
...
### Data Flow
[Step by step: how data moves through the system during a typical execution path]
